...
const StickyNoteNode = ({ data, selected }: NodeProps<StickyNoteNodeData>) => {
  ...
  return (
    <div
      style={{
        ...
        backgroundColor: object.fillColor || '#fff59d',
        ...
        background: `linear-gradient(135deg, ${object.fillColor || '#fff59d'} 0%, ${object.fillColor || '#fff59d'}dd 100%)`,
      }}
